        ...
        <div className="flex flex-col items-start md:items-end gap-4">
          ...
          <div className="flex gap-2.5">
            {[
              ...
              { icon: Linkedin, href: "https://linkedin.com/company/gdg-apsit", label: "LinkedIn" },
              { icon: Instagram, href: "https://instagram.com/gdgapsit", label: "Instagram" },
              { icon: Globe, href: "https://gdg.community.dev", label: "GDG" },
            ].map(s => (
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 py-10 sm:py-14
        ...
        <div>
          ...
          <a href="https://gdg.community.dev" target="_blank" rel="noopener noreferrer"
            ...
            <span className="font-dm text-white/60 text-sm group-hover:text-white transition-colors">gdg.community.dev</span>
